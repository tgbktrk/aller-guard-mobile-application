...
|-------------------|----------------------|-------------------------------|
| ![Allergen Detected](./screenshots/allergen_warning1.PNG) | ![No Allergen Detected](./screenshots/allergen_warning2.PNG) | ![Add Allergen Warning](./screenshots/alerjen_giris_uyarısı.PNG) |
